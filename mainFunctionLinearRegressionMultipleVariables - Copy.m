...
% Estimate the price of a 2500 sq-ft, 4 br house 
normalizedSquareFeet = (2500 - mu) / sigma;
normalizedNumberOfBedrooms = (4 - mu) / sigma;

normalizedInput = [1, normalizedSquareFeet, normalizedNumberOfBedrooms];
estimatePriceUsingGradientDescent = normalizedInput * theta5; 

fprintf(['Predicted estimatePriceUsingGradientDescent of a 2500 sq-ft, 4 br house ' ...
...
% Estimate the price of a 2500 sq-ft, 4 br house
price = [1, 2500, 4] * theta; 

fprintf(['Predicted price of a 2500 sq-ft, 4 br house ' ...
